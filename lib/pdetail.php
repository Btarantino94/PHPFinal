      ...
      <form method="get" action="cart.php">
         <!-- <div class="options">
            <div class="buying_options">
               <div class="select">
                  <select id="type">
                     <option name = "option" value = "1">T-shirt</option>
                     <option name = "option" value = "2">Baseball</option>
                  </select>
               </div>
               <div class="select">
                  <select id="size">
                     <option name = "option" value = "1">Small</option>
                     <option name = "option" value = "2">Medium</option>
                     <option name = "option" value = "3">Large</option>
                     <option name = "option" value = "4">X-Large</option>
                  </select>
               </div>
               <div class="select">
                  <select id="type">
                     <option name = "option" value = "1" >Blue</option>
                     <option name = "option" value = "2">Black</option>
                     <option name = "option" value = "3">green</option>
                     <option name = "option" value = "4">grey</option>
                     <option name = "option" value = "5">white</option>
                  </select> -->
                  <!-- </div> -->
                  <!-- </div> -->
                  <!-- buying options

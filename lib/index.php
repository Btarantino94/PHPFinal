...
<body class="home_body">
    ...
    <section id="homepage_hero">
        <div class="container align-center">
            ...
            <div class="topad_con">
                <a href="featured.php">
                    <figure><img src="img/halload.jpg" alt="halloween banner"></figure>
                </a>
            </div>
        </div>
        <!-- container end -->
    ...
    <div class="ad_con">
        <a href="topsellers.php">
            <figure id="starwars"><img src="img/star_wars_ad.jpg" alt="star wars banner"></figure>
        </a>
    </div>
    <div id="missing_container">
        <p id="missing_out">YOU'RE MISSING OUT</p>
        <h2 id="missing_text">Stay up to date with our exclusive products, contests, giveaways and everything that is awesome! Subscribe to our newsletter below and start receiving all the hand-picked products and other geeky awesomeness straight in your inbox. <a href="contact.php">Here!</a></h2>
    </div>
    <div class="ad_con">
        <a href="new.php">
            <figure id="comingsoon"><img src="img/coming.jpg" alt="coming soon banner"></figure>
        </a>
    </div>
